...
function VideoChat() {
  ...
  return (
    <>
      <h1 style={{ textAlign: "center", color: "#000" }}>Video Chat</h1>
      <div className="container">
        ...
        <div className="myId">
          ...
          />
          <CopyToClipboard text={me} onCopy={() => console.log(`ID ${me} copied successfully!`)}>
            <button className="vchat-button">Copy ID</button>
          </CopyToClipboard>
          <input
            type="text"
